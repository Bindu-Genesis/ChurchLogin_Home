        ...
        <>
            <div className="container relative" id="review">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <p className="text-slate-400 max-w-xl mx-auto">At Church Login, we’re committed to helping churches thrive by simplifying their administrative tasks. But don’t just take our word for it—see how our users are experiencing the difference!</p>
                </div>
