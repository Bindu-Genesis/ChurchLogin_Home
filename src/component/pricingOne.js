    ...
    <div className="grid lg:grid-cols-12 grid-cols-1 items-center gap-[30px]">
        <div className="lg:col-span-5">
          <div className="lg:text-start text-center">
            <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Customizable Plans for Every Church</h3>

            <p className="text-slate-400 max-w-xl mx-auto">Select a pricing tier based on the number of members (families) in your church. Additional pricing options are available to cater to specific needs.</p>

            <div className="mt-6">
                  {/* services page link here - /page-pricing*/}
